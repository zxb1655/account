...
const store =  new Vuex.Store({
  ...
  mutations: {
    ...
    fetchLabels(state){
      const defauleLabels = ['默认','衣','食','住','行'];
      state.labels = JSON.parse(window.localStorage.getItem(localStorageKeyName) || JSON.stringify(defauleLabels));
    },
    saveLabels(state){
